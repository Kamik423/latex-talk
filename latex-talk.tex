...
\begin{frame}[fragile]
    ...
    \begin{multicols}{2}
        ...
        \input{images/tikzplotlib/units}
...
\usepackage[ngerman]{babel}
    \end{lstlisting}
    \note[item]{Konfiguriert auch icomma, siunitx}
\end{frame}
...
\begin{frame}[fragile]
    ...
    \begin{figure}
        \begin{subfigure}{.3333\textwidth}
            \centering
            \includegraphics[page=1,width=0.85\linewidth]{images/float/float.pdf}
            \raisebox{10ex}{\invisirule{}}
        \end{subfigure}%
        \begin{subfigure}{.3333\textwidth}
            \centering
            \includegraphics[page=2,width=0.85\linewidth]{images/float/float.pdf}
            \raisebox{10ex}{\wrongrule{}}
        \end{subfigure}%
        \begin{subfigure}{.3333\textwidth}
            \centering
            \includegraphics[page=3,width=0.85\linewidth]{images/float/float.pdf}
            \raisebox{10ex}{\invisirule{}}
        \end{subfigure}%
    \end{figure}
\end{frame}
...
\begin{frame}[fragile]
    ...
    \begin{figure}
        \begin{subfigure}{0.5\textwidth}
            \centering
            \raisebox{6ex}{\includegraphics[width=.35\linewidth]{images/python}}
        \end{subfigure}%
        \begin{subfigure}{0.5\textwidth}
            \centering
        ...
        \end{subfigure}%
        \begin{subfigure}{0.5\textwidth}
            \raisebox{0.65ex}{\input{images/tikzplotlib/tpl-example-edit}}
...
\begin{frame}[fragile]
    ...
    \begin{itemize}
        \item Book Weight
        \item Unicode (ελληνική Україна ⠅⠆⠇⠝⠞ \smash{x̧̗̖̀́̃̂} ☭ Ⳃ ʛ)
    \end{itemize}
\end{frame}
